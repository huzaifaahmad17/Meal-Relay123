...
const mockInsights = {
  ...
  predictions: [
    ...
    },
    {
      ...
      description: 'NGO requests likely to increase by 25% in Mansarovar area due to monsoon season.',
      confidence: 87,
      timeframe: '1 month',
      impact: 'medium',
    ...
    },
    {
      ...
      description: 'AI identified 18% potential reduction in delivery time for Jaipur routes.',
      confidence: 95,
      timeframe: 'immediate',
      impact: 'medium',
