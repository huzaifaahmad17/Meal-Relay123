...
const mockChatRooms: ChatRoom[] = [
  {
    ...
    type: 'direct',
    participants: [
      { id: 'ngo1', name: 'Jaipur Food Bank', role: 'ngo', online: true },
  ...
  },
  {
    ...
    participants: [
      ...
      { id: 'ngo1', name: 'Jaipur Food Bank', role: 'ngo', online: false, lastSeen: new Date('2024-01-15T13:00:00') },
    ...
    lastMessage: {
      ...
      senderRole: 'admin',
      content: 'Emergency situation in Mansarovar area. Need immediate food donations.',
